...
from info import AUTH_CHANNEL, LONG_DROPLINK_URL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTENER_API, SHORTILINK_URL,SHORTLINK_URL,SHORTLINK_API,SHORTILINK_API
